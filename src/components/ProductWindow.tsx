...
export const ProductWindow: React.FC<ProductWindowProps> = ({ product, onClose, zIndex }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed left-1/2 top-1/2 w-[500px] max-w-[90vw] bg-[#c0c0c0] border-2 border-t-white border-l-white border-r-[#404040] border-b-[#404040] shadow-xl flex flex-col font-mono"
      style={{ 
        x: '-50%', 
        y: '-50%',
        zIndex 
    ...
    >
      {/* Window Header */}
      <div className="h-8 bg-ndm-primary flex items-center justify-between px-2 cursor-grab active:cursor-grabbing select-none m-1">
        <span className="text-xs font-bold text-ndm-dark uppercase tracking-widest truncate">
